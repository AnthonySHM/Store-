...
function getAllProducts(req, res) {
    db.query('SELECT * FROM products', (err, results) => {
        ...
        return res.status(201).json({ message: 'Products successfully', data: results }); // Return de response status 200 or 201 is required
        //This line ruturn de results of you query
      })
}

function getProductById(req, res) {
  const productId = req.params.id;
  //TABLE NAME IS products NOT productos
